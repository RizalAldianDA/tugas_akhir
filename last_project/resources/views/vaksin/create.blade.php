                ...
                <div class="col-md-8 col-xl-6">
                    ...
                    <form action="{{route('vaksin.store')}}" method="POST">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik" value="{{ session()->get('nik') }}">
                            @error('nik')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('vaksin') is-invalid @enderror" id="vaksin" name="vaksin" value="{{ old('vaksin') }}">
                            @error('vaksin')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tanggal_vaksinasi') is-invalid @enderror" id="tanggal_vaksinasi" name="tanggal_vaksinasi" value="{{ old('tanggal_vaksinasi') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('vaksinasi_ke') is-invalid @enderror" id="vaksinasi_ke" name="vaksinasi_ke" value="{{ old('vaksinasi_ke') }}">
                            @error('vaksinasi_ke')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="keluhan_vaksinasi" rows="3" name="keluhan_vaksinasi">{{ old('keluhan_vaksinasi') }}</textarea>
                        </div>
